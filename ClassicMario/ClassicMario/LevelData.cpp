...
CLevelData::CLevelData()
{
	...
	*/
	...
	m_colleciblesData.push_back({ sf::Vector2f(254, 136), ECollectible::Coin });
	m_colleciblesData.push_back({ sf::Vector2f(336, 136), ECollectible::FireFlower });
	m_colleciblesData.push_back({ sf::Vector2f(368, 136), ECollectible::Coin });
	m_colleciblesData.push_back({ sf::Vector2f(352, 72), ECollectible::Coin });
	m_colleciblesData.push_back({ sf::Vector2f(1248, 136), ECollectible::FireFlower });
	m_colleciblesData.push_back({ sf::Vector2f(1504, 72), ECollectible::Coin });
	m_colleciblesData.push_back({ sf::Vector2f(1744, 72), ECollectible::FireFlower });
	m_colleciblesData.push_back({ sf::Vector2f(1696, 136), ECollectible::Coin });
	m_colleciblesData.push_back({ sf::Vector2f(1744, 136), ECollectible::Coin });
	m_colleciblesData.push_back({ sf::Vector2f(1792, 136), ECollectible::Coin });
	m_colleciblesData.push_back({ sf::Vector2f(2064, 72), ECollectible::Coin });
	m_colleciblesData.push_back({ sf::Vector2f(2080, 72), ECollectible::Coin });
	m_colleciblesData.push_back({ sf::Vector2f(2720, 136), ECollectible::Coin });
...
/*
	returns the collectible data that is which collectible is in which question block
*/
const std::vector<std::pair<sf::Vector2f, ECollectible>>& CLevelData::GetCollectibleData()
{
	return m_colleciblesData;
}
